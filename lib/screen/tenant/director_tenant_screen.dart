...
class DirectorTenantScreen extends StatefulWidget {
  final VoidCallback? onSuccess; // 🔥 para volver a Materias

  const DirectorTenantScreen({super.key, this.onSuccess});
...
class _DirectorTenantScreenState extends State<DirectorTenantScreen> {
  ...
  XFile? _selectedFile;        // 🔥 antes era String? _selectedImagePath
  Uint8List? _previewBytes;    // 🔥 para preview en web y móvil
                      ...
                      children: [
                        ...
                        Center(
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              // 🔥 Image.memory en vez de Image.file
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            // 🔥 _selectedFile en vez de _selectedImagePath
                            onPressed: _selectedFile == null
                                ? null
                                : () async {
                                    final ok =
                                        await vm.uploadLogo(_selectedFile!);
                                    if (!mounted) return;
