...
class _EstudianteListScreenState extends State<EstudianteListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () async { context.go('/estudiantes/create');},
          /* final result = await context.push('/estudiantes/nuevo');
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () async {
                            ...
                            if (confirm == true && mounted) {
                              final success =
                                  await vm.deleteEstudiante(e.id!);
